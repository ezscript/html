...
//穿越
var testAcross = function(user){
	if(user.x == specialPointL.x -1 && user.y ==  specialPointL.y){
		user.x = specialPointR.x + 1;
		user.y = specialPointR.y;
	}else if(user.x == specialPointR.x + 1 && user.y ==  specialPointR.y){
		user.x = specialPointL.x -1;
		user.y = specialPointL.y;
	}
}